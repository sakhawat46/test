    ...
    <div className="min-h-screen bg-[#f5eef4] flex items-center justify-center p-3">
      ...
      >
        ...
        <div className="px-7 pb-3 text-center">
          <h2 className="font-serif text-[1.55rem] font-bold text-[#38404B] leading-tight">
        ...
        {/* Product stage — gradient set with horizon + reflection, image whole */}
        <div className="px-4 pb-2">
          <div
            className="relative rounded-2xl overflow-hidden"
            style={{ background: "linear-gradient(180deg, #f3fbfb 0%, #eafafa 48%, #f0e7ef 49%, #f7eef4 100%)" }}
          >
            {/* horizon line */}
            <div className="absolute left-0 right-0" style={{ top: "49%", height: "1px", background: "linear-gradient(to right, transparent, rgba(78,183,192,0.35), rgba(240,50,122,0.25), transparent)" }} />
            {/* glow */}
            <div
              aria-hidden
              ...
              style={{
                background:
                  "radial-gradient(ellipse 55% 40% at 40% 45%, rgba(78,183,192,0.34) 0%, transparent 65%)," +
                  "radial-gradient(ellipse 48% 38% at 68% 48%, rgba(240,50,122,0.24) 0%, transparent 62%)",
                filter: "blur(18px)",
              }}
            />
            <div className="relative px-6 pt-5">
              <img
                ...
                style={{ filter: "drop-shadow(0 16px 22px rgba(56,64,75,0.22))" }}
              />
              {/* reflection */}
              <div className="overflow-hidden -mt-1" style={{ height: "40px" }}>
                <img
                  src="/__mockup/images/sculpt-vials-nobg.png"
                  alt=""
                  aria-hidden
                  className="w-full h-auto block"
                  style={{ transform: "scaleY(-1)", opacity: 0.18, maskImage: "linear-gradient(to bottom, black, transparent 70%)", WebkitMaskImage: "linear-gradient(to bottom, black, transparent 70%)", marginTop: "-72%" }}
                />
              </div>
            </div>
            {/* Seal */}
