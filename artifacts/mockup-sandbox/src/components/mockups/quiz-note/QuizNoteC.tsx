export default function QuizNoteC() {
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "white", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div style={{ width: "100%", maxWidth: "360px", background: "white", borderRadius: "24px", boxShadow: "0 4px 32px rgba(0,0,0,0.08)", overflow: "hidden" }}>
        ...
        <div style={{ padding: "28px 24px 32px" }}>
          ...
          {/* C: note tucked right of headline as a small aside */}
          <div style={{ display: "flex", alignItems: "flex-start", gap: "10px", marginBottom: "6px" }}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "26px", fontWeight: 700, color: "#38404B", lineHeight: 1.25, margin: 0, flex: "0 0 auto" }}>
              How old are you?
            </h2>
          </div>
          <p style={{ fontSize: "14px", color: "#8c96a3", marginBottom: "18px", lineHeight: 1.5 }}>
            GLP-1 therapy is available to adults 18 and older.
          </p>

          {/* Full-width handwritten banner strip */}
          <div style={{
            background: "linear-gradient(135deg, #FFF0F6 0%, #fff5fb 100%)",
            borderLeft: "3px solid #F0327A",
          ...
          <button style={{ marginTop: "22px", width: "100%", padding: "14px", borderRadius: "99px", background: "#4EB7C0", color: "white", fontSize: "15px", fontWeight: 600, border: "none", cursor: "pointer" }}>
            Continue →
          </button>
