      ...
      <div className="w-full max-w-[460px]">
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/60 border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 pb-8">
            ...
            {/* VARIANT B: muted legal block below CTA, separated by a thin rule */}
            <div className="mt-5 pt-4 border-t border-dashed border-gray-200">
              <p className="text-[10px] text-muted-foreground leading-relaxed text-center">
                ...
                Compounded semaglutide and tirzepatide are not FDA-approved and have not been evaluated by the FDA for safety or effectiveness. These are compounded medications prepared by an independent licensed U.S. pharmacy — not generic versions of brand-name GLP-1 medications.
              </p>
            </div>
          </div>
        </div>
