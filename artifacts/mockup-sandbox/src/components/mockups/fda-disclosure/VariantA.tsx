      ...
      <div className="w-full max-w-[460px]">
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/60 border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 pb-8">
            ...
            {/* VARIANT A: FDA banner between subtitle and cards */}
            <div className="flex items-start gap-2.5 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-5">
              ...
              <p className="text-[11px] text-amber-800 leading-relaxed">
                <strong>FDA Disclosure:</strong> Compounded semaglutide and tirzepatide are not FDA-approved and have not been evaluated by the FDA for safety or effectiveness. These are compounded medications prepared by an independent licensed U.S. pharmacy — not generic versions of brand-name GLP-1 medications.
              </p>
            </div>
