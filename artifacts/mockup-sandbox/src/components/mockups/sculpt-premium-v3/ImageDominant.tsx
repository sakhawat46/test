...
export default function ImageDominant() {
  return (
    <div className="min-h-screen bg-[#f5eef4] flex items-center justify-center p-3">
      <div className="w-[390px] bg-white rounded-3xl overflow-hidden" style={{ boxShadow: "0 24px 80px rgba(78,183,192,0.16), 0 4px 20px rgba(240,50,122,0.09)" }}>
        ...
        {/* Content row: paragraph (left) + vials (right). Height is driven by content; no fixed min-height or spacers. */}
        <div
          className="px-2 -mt-6 grid items-center"
          style={{ gridTemplateColumns: "minmax(180px, 240px) minmax(180px, 260px)", columnGap: "4px" }}
        >
          {/* Left column: paragraph, auto height */}
          <div className="pl-4" style={{ height: "auto" }}>
            <p className="text-[11.5px] text-[#6b7280] leading-[1.5]">
          ...
          <div className="relative flex items-center justify-end">
            ...
            <img
              ...
              alt="vials"
              className="relative w-[240px] max-w-none"
              style={{ marginRight: "-30px", filter: "drop-shadow(0 14px 28px rgba(78,183,192,0.26)) drop-shadow(0 5px 12px rgba(0,0,0,0.10))" }}
            />
          </div>
        </div>

        {/* Cards — begin immediately after the content row; tape overlaps the top edge slightly */}
        <div className="px-6 grid grid-cols-2 gap-2.5" style={{ marginTop: "-10px" }}>
