...
/** Compact Rx — x overlaps more into R's lower quadrant, tighter mark */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F7FF] via-white to-[#FEF0F5] flex flex-col items-center justify-center gap-10 p-8">
      ...
      <div className="bg-white border border-gray-200 rounded-xl px-5 py-3 text-center">
        <p className="text-[12px] font-semibold text-[#38404B]">B — Compact</p>
        <p className="text-[11px] text-gray-400 mt-0.5">x at 54% · deeper overlap · tighter mark</p>
      </div>
    </div>
  );
}
