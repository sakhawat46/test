...
/** Dramatic Rx — bold R, small x, high contrast, maximum prescription feel */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F7FF] via-white to-[#FEF0F5] flex flex-col items-center justify-center gap-10 p-8">
      ...
      <div className="bg-white border border-gray-200 rounded-xl px-5 py-3 text-center">
        <p className="text-[12px] font-semibold text-[#38404B]">C — Dramatic</p>
        <p className="text-[11px] text-gray-400 mt-0.5">x at 48% · R extra bold · high contrast mark</p>
      </div>
    </div>
  );
}
