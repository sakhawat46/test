...
// Variant C — two-line stacked: price on top, timing below, slightly indented
export default function PriceC() {
  return (
    <div style={{ fontFamily: "Inter, sans-serif", background: "linear-gradient(to bottom, #ffffff 0%, #f5f0f8 100%)", width: 390, height: 720, position: "relative", overflow: "hidden", boxSizing: "border-box" }}>
      ...
      <div style={{ position: "absolute", top: 80, left: 24, right: 24, zIndex: 10 }}>
        ...
        {/* ── VARIANT C: Two-line — price line 1, timing line 2 (indented) ── */}
        <div style={{ marginTop: 14, transform: "rotate(-3deg)", transformOrigin: "left center", display: "inline-block" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <span style={{ fontFamily: "'Caveat', cursive", fontSize: "1.85rem", fontWeight: 700, color: pink, lineHeight: 1, transform: "rotate(15deg)", display: "inline-block" }}>*</span>
            <span style={{ fontFamily: "'Caveat', cursive", fontSize: "1.22rem", fontWeight: 600, color: pink, lineHeight: 1.2, whiteSpace: "nowrap" }}>
              Plans from $199/mo.
            </span>
          </div>
          <div style={{ paddingLeft: 28 }}>
            <span style={{ fontFamily: "'Caveat', cursive", fontSize: "1.05rem", fontWeight: 500, color: pink, lineHeight: 1.2, whiteSpace: "nowrap", opacity: 0.65 }}>
              Takes 2 mins. Really.
            </span>
          </div>
        </div>
        ...
        {/* Trust */}
        <div style={{ marginTop: 162, display: "flex", flexDirection: "column", gap: 7 }}>
