...
// Variant B — price part larger/bolder, timing part smaller and softer
  ...
  return (
    <div style={{ fontFamily: "Inter, sans-serif", background: "linear-gradient(to bottom, #ffffff 0%, #f5f0f8 100%)", width: 390, height: 720, position: "relative", overflow: "hidden", boxSizing: "border-box" }}>
      ...
      <div style={{ position: "absolute", top: 80, left: 24, right: 24, zIndex: 10 }}>
        ...
        {/* ── VARIANT B: Price portion larger + bold, timing smaller + faded ── */}
        <div style={{ marginTop: 14, display: "inline-flex", alignItems: "baseline", gap: 4, transform: "rotate(-3deg)", transformOrigin: "left center" }}>
          ...
          <span style={{ fontFamily: "'Caveat', cursive", fontSize: "1.38rem", fontWeight: 700, color: pink, lineHeight: 1.2, whiteSpace: "nowrap" }}>
            Plans from $199/mo.
          </span>
          <span style={{ fontFamily: "'Caveat', cursive", fontSize: "1.05rem", fontWeight: 500, color: "rgba(240,50,122,0.5)", lineHeight: 1.2, whiteSpace: "nowrap" }}>
            Takes 2 mins.
          </span>
        </div>
