...
export function GhostedHandwrittenA() {
  useEffect(() => {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", backgroundColor: "#fff", maxWidth: 390, margin: "0 auto" }}>
      ...
      <div style={{ padding: "32px 24px 36px", textAlign: "center", background: "linear-gradient(145deg, #fff0f5 0%, #e8f8f9 60%, #fde8f1 100%)" }}>
        ...
        {/* HANDWRITTEN ACCENT A — annotates the headline from above */}
        <div style={{ display: "flex", justifyContent: "flex-end", paddingRight: 8, marginBottom: 4 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <span style={{ fontFamily: "'Caveat', cursive", fontSize: 21, color: PINK, fontWeight: 700, transform: "rotate(-5deg)", display: "inline-block" }}>
              yes, this is for you
            </span>
            {/* Arrow pointing down-left toward headline */}
            <svg width="24" height="28" viewBox="0 0 24 28" fill="none">
              <path d="M18 2 C14 8, 8 14, 6 24" stroke={PINK} strokeWidth="1.8" fill="none" strokeLinecap="round"/>
              <path d="M2 20 L6 24 L11 21" stroke={PINK} strokeWidth="1.8" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
