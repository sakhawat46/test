...
export function GhostedHandwrittenB() {
  useEffect(() => {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", backgroundColor: "#fff", maxWidth: 390, margin: "0 auto" }}>
      ...
      <div style={{ padding: "32px 24px 36px", textAlign: "center", background: "linear-gradient(145deg, #fff0f5 0%, #e8f8f9 60%, #fde8f1 100%)" }}>
        <span style={{ display: "inline-flex", alignItems: "center", gap: 6, backgroundColor: "#fff", border: `1px solid ${PINK}`, borderRadius: 999, padding: "4px 14px", fontSize: 12, fontWeight: 600, color: PINK, marginBottom: 12 }}>
          <Heart size={12} fill={PINK} color={PINK} /> Designed for Women
        </span>

        {/* HANDWRITTEN ACCENT B — "sound familiar?" intro before the headline */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 10 }}>
          <svg width="32" height="20" viewBox="0 0 32 20" fill="none">
            <path d="M30 4 C22 4, 10 8, 4 16" stroke={PINK} strokeWidth="1.8" fill="none" strokeLinecap="round"/>
            <path d="M8 10 L4 16 L10 17" stroke={PINK} strokeWidth="1.8" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span style={{ fontFamily: "'Caveat', cursive", fontSize: 24, color: PINK, fontWeight: 700, transform: "rotate(-3deg)", display: "inline-block" }}>
            sound familiar?
          </span>
        </div>
        ...
        <p style={{ fontSize: 15, color: "#666", lineHeight: 1.6, maxWidth: 280, margin: "0 auto 28px" }}>
