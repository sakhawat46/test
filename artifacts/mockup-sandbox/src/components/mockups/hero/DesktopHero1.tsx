...
export function DesktopHero1() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "linear-gradient(to bottom, #ffffff 0%, rgba(240,228,235,0.35) 100%)", minHeight: 760 }}>
      ...
      {/* HERO — tightened two-column grid, image column narrowed + bottom-aligned, gap reduced */}
      <section style={{ maxWidth: 1180, margin: "0 auto", padding: "56px 40px 40px", display: "flex", justifyContent: "center", alignItems: "center", gap: 8 }}>
        {/* TEXT */}
        ...
        {/* IMAGE — bottom-aligned to the text block, contained, no floating */}
        <div style={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "flex-end", alignSelf: "stretch", marginLeft: -20 }}>
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: 300, height: 300, borderRadius: "50%", background: "rgba(78,183,192,0.16)", filter: "blur(60px)", pointerEvents: "none" }} />
          <img
            src={VIAL}
