...
export function DesktopHero2() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "linear-gradient(to bottom, #ffffff 0%, rgba(240,228,235,0.35) 100%)", minHeight: 760 }}>
      ...
      {/* HERO — image anchored inside a soft rounded panel so it reads as one unit, not floating */}
      <section style={{ maxWidth: 1180, margin: "0 auto", padding: "56px 40px 48px", display: "flex", justifyContent: "center", alignItems: "center", gap: 24 }}>
        {/* TEXT */}
        <div style={{ maxWidth: 480, flexShrink: 0 }}>
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 60, fontWeight: 700, lineHeight: 1.05, color: INK, margin: "0 0 22px" }}>
            Lose the weight.<br />
            <span style={{ color: PINK }}>Feel like yourself again.</span>
          </h1>
          <p style={{ fontSize: 20, color: "#6b6470", lineHeight: 1.6, fontWeight: 300, margin: "0 0 30px", maxWidth: 470 }}>
        ...
        {/* IMAGE inside a framed gradient panel — visually grounds the vial */}
        <div
          style={{
            position: "relative",
            borderRadius: 32,
            background: "linear-gradient(155deg, rgba(78,183,192,0.12) 0%, rgba(240,50,122,0.08) 100%)",
            border: "1px solid rgba(78,183,192,0.18)",
            width: 440,
            flexShrink: 0,
            height: 440,
            display: "flex",
        ...
        >
          <div style={{ position: "absolute", top: "42%", left: "50%", transform: "translate(-50%,-50%)", width: 280, height: 280, borderRadius: "50%", background: "rgba(78,183,192,0.22)", filter: "blur(55px)", pointerEvents: "none" }} />
          <img
            src={VIAL}
