export function Band1() {
  return (
    <div style={{ minHeight: "100vh", background: "white", display: "flex", flexDirection: "column", fontFamily: "sans-serif", maxWidth: 390, margin: "0 auto" }}>
      ...
      {/* ── BAND V1 — Side by Side, full width ── */}
      <div style={{
        padding: "14px 20px",
        ...
        {/* Left: quote filling the space */}
        <div style={{ flex: 1 }}>
          <p style={{ fontFamily: "Georgia, serif", fontStyle: "italic", fontSize: 14, color: "#38404B", margin: 0, lineHeight: 1.45 }}>
            "Because our patients deserve it."
          </p>
          <p style={{ fontSize: 10, color: "#9ca3af", margin: "5px 0 0", letterSpacing: "0.04em" }}>— SculptRx Mission</p>
        </div>
      ...
      <div style={{ marginTop: "auto", padding: "14px 24px", textAlign: "center", borderTop: "1px solid #e5e7eb" }}>
        <p style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", color: "#4EB7C0", margin: 0 }}>V1 — Side by Side with Divider</p>
        <p style={{ fontSize: 10, color: "#9ca3af", marginTop: 3 }}>Quote left · Vertical rule · Badge right</p>
      </div>
    </div>
  );
}
